...
<div class="container-fluid">
	<form action="" id="login-frm">
		...
		<div class="form-group">
			...
			<input type="text" name="registrationId" required class="form-control">
		</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					$('#login-frm').prepend('<div class="alert alert-danger">Incorrect Email, Registration ID, or Password.</div>')
					$('#login-frm button[type="submit"]').removeAttr('disabled').html('Login');
				}
			}
		})
