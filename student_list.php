                            ...
                            <div class="row align-items-center h-100">
                                <div class="">
                                    <div>
                                        ...
                                        <p class="filter-txt">Roll No: <b><?php echo $row['registrationId'] ?></b></p>
                                        <p class="filter-txt">Admission Year: <b><?php echo $row['admission_year'] ?></b></p>
                                        <p class="filter-txt">Pass-out Year: <b><?php echo $row['passout_year'] ?></b></p>
                                        <a href="view_student_profile.php?id=<?php echo $row['id'] ?>" class="btn btn-info btn-sm">View Profile</a>
                                        <br>
                                    </div>
                                </div>
                            </div>
