...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=achievements" class="nav-item nav-gallery"><span class='icon-field'><i class="fa fa-image"></i></span> Dashboard </a>
				...
				<a href="index.php?page=student" class="nav-item nav-alumni"><span class='icon-field'><i class="fa fa-users"></i></span> Student List</a>
				...
				<a href="index.php?page=home" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-home"></i></span> Go To Home</a>
